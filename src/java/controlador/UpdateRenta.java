 ...
 * @author Hector
 */
@WebServlet(name = "UpdateRenta", urlPatterns = {"/UpdateRenta"})
public class UpdateRenta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         mysql.OperaMysql op = new OperaMysql();
         
         if(fechaEntrega.equals("0000-00-00"))
         {
             op.UpdateRenta(titulo, clasificacion, cantidad, fechaRenta, fechaEntrega, recargo, nombreSocio, idrenta);
             response.sendRedirect("index.jsp");
         }
         else{
             op.UpdateRenta(titulo, clasificacion, cantidad, fechaRenta, fechaEntrega, recargo, nombreSocio, idrenta);
             op.UpdateCantP2(cantidad, idpelicula);
             response.sendRedirect("index.jsp");
         }
